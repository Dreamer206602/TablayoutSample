 ...
 */
public class TodayAnswerFragment extends Fragment {
    ...
    public static TodayAnswerFragment getInstance() {

        sTodayAnswerFragment = new TodayAnswerFragment();
        return sTodayAnswerFragment;
    }


    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_today_answer, container, false);
    ...
    private void init() {
        for (int i = 0; i < 4; i++) {
            ...
            answerInfos.add(new AnswerInfo(i+"today", "A", "A、1939年9月1日，波兰"));
            answerInfos.add(new AnswerInfo(i+"today", "B", "B、1939年4月1日，波兰"));
            answerInfos.add(new AnswerInfo(i+"today", "C", "C、1929年9月1日，波兰"));
            answerInfos.add(new AnswerInfo(i+"today", "D", "D、1939年1月1日，波兰"));
